...
describe("App component", () => {
  it("Renders the App component with the correct elements", () => {
    // render(<App/>);
...
describe("Main Table component", () => {
  it("Renders the table", async () => {
    ...
    const mainColumnName = screen.getByText('Name');
    const columnSuccess = screen.getByText('Launch Date');
    const columnDetails = screen.getByText('Details');
    const columnRocketID = screen.getByText('Rocket ID');  

    const cellName = screen.getByText('falconSat');

    expect(mainColumnName).toBeInTheDocument();
    expect(columnSuccess).toBeInTheDocument();
    expect(columnDetails).toBeInTheDocument();
